 function getJSOrganization() {
        ...
        function showProposal(id) {
  document.querySelectorAll('.proposal-screen')
  ...
  if (noBtn) {
    noBtn.addEventListener("mouseenter", e => moveRandomEl(e.target));
    noBtn.addEventListener("click", e => moveRandomEl(e.target));
  }

  loadLottie("Sowrov1", "https://botfather.cloud/Assets/Sticker/pleading_face.json");
  loadLottie("Sowrov2", "https://botfather.cloud/Assets/Sticker/sad_duck.json");
  loadLottie("Sowrov3", "https://botfather.cloud/Assets/Sticker/crying_wtr_duck.json");
  loadLottie("Sowrov4", "https://botfather.cloud/Assets/Sticker/loud_cry_duck.json");
  loadLottie("Sowrov5", "https://botfather.cloud/Assets/Sticker/jumping_together_with_love.json");
});
